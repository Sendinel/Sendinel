...
urlpatterns = patterns("",
    ...
    # previous staff urls
    url(r"^$", redirect_to, {'url': 'list_infoservices/'}),
    url(r"^logout/$", 'sendinel.groups.views.logout_staff', name = 'staff_logout'),
    url(r"^list_infoservices/$", 'sendinel.groups.views.list_infoservices', 
        name = 'staff_list_infoservices'),
    url(r"^infoservice/create/$", 'sendinel.groups.views.create_infoservice', 
